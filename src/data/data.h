...
constexpr int X_MM = 0;
constexpr int X_DEG = 1;
constexpr int TEMPORAL_INDEX = 2;
constexpr int NASAL_INDEX = 4;
...
// visual field.";
inline const std::vector<std::vector<double>> CurcioConeDensities = {{0., 0.04975, 0.0995, 0.14925, 0.199,
